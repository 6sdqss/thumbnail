...
FONT_WEIGHT = 700; WHITE_TOL = 18; TEXT_PADDING = 20
...
# ═══ PRESETS ═══
PRESETS = {
    "🎯 Chuẩn (PS mẫu)": dict(top_margin=155,bottom_margin=35,side_padding=40,product_scale=1.0,center_mode="centroid",font_size=26),
