...
DEFAULT_FONT_SIZE = 33.0       # PS 24pt × (96/72) = 32px
DEFAULT_TRACKING = 28          # ĐÃ SỬA THÀNH SỐ DƯƠNG ĐỂ CHỮ GIÃN THOÁNG RA
...
# ═══ PRESETS ═══
PRESETS = {
    "🎯 Chuẩn (PS mẫu)": dict(top_margin=155,bottom_margin=35,side_padding=35,product_scale=1.0,center_mode="centroid",font_size=33.0),
