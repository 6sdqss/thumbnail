...
DEFAULT_FONT_FAMILY = "MontserratAlternates-Bold"
DEFAULT_FONT_SIZE = 28.5       # PS 24pt × (96/72) = 32px
...
# ═══ PRESETS ═══
PRESETS = {
    "🎯 Chuẩn (PS mẫu)": dict(top_margin=155,bottom_margin=35,side_padding=35,product_scale=1.0,center_mode="centroid",font_size=28.5),
